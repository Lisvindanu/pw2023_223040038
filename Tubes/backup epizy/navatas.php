        ...
        <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto py-3 test">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '<li><a class="dropdown-item" href="php/kategori.php?kategori=' . $row['nama'] . '">' . $row['nama'] . '</a></li>';
                        }
                        ?>
                    </ul>
                </li>
                ...
                <?php if (isset($_SESSION['submit']) && $_SESSION['submit'] === true) {
                    echo '<a class="btn btn-outline-danger px-3 logingp" role="button" href="php/admin.php">admin</a>';
                } else {
                    echo '<a class="btn btn-outline-danger px-3 logingp" role="button" href="php/login.php">Login</a>';;
                } ?>
